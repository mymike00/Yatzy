...
UBUNTU_TRANSLATION_DOMAIN="yatzy.mike"
...
aptest.commands = bash $$PWD/Yatzy/tests/autopilot/run
aptest.depends  = sub-Yatzy

unittest.target   = check
unittest.commands = /usr/bin/qmltestrunner -input $$PWD/Yatzy/tests/unit 
unittest.depends  = sub-Yatzy
